<?php $query = mysql_query("SELECT * FROM tb_penjualan tp JOIN tb_barang tb ON tb.kode_barang=tp.kode_barang JOIN tb_cabang tc ON tc.kode_cabang=tp.kode_cabang JOIN tb_jenistransaksijual tj ON tj.kode_jenistransaksijual=tp.kode_jenistransaksijual") or die(mysql_error());?>
